...
// show a person's profile if the profile option is chosen ------------------------------------------------------------
    ...
    else if (document.getElementById("profiles-input").checked === true) 
    {
        ...
        {
            const uri = "http://gjarman2020.com/cgi-bin/mcaListProfile.cgi" + "?PersonID=" + PersonIDValue;
            let response = await fetch(uri);
            if (response.ok) {
                text1 = await response.text();
                text2 = text1.replace(/\|/g, ", ");
...
// show a person's reference links if the profile option is chosen ------------------------------------------------------------
        ...
        {
            const uri = "http://gjarman2020.com/cgi-bin/mcaListProfRefLinks.cgi" + "?PersonID=" + PersonIDValue;
            let response = await fetch(uri);
            if (response.ok) {
...
// show portraits if the portraits option is chosen -------------------------------------------------------------------
    ...
    else if (document.getElementById("portraits-input").checked === true) 
    {
        ...
        const uri = "http://gjarman2020.com/cgi-bin/mcaListPortraits.cgi" + "?PersonID=" + PersonIDValue;
        let response = await fetch(uri);
        if (response.ok)
        {
            text1 = await response.text();
...
// list marriages if the marriages option is chosen -------------------------------------------------------------------
    ...
    {
        const uri = "http://gjarman2020.com/cgi-bin/mcaListMarriages.cgi";
        let response = await fetch(uri);
        if (response.ok) {
            text1 = await response.text();
            text2 = text1.replace(/\|/g, ", ");
...
// list residents if the residents option is chosen -------------------------------------------------------------------
    ...
    {
        const uri = "http://gjarman2020.com/cgi-bin/mcaListResidents.cgi";
        let response = await fetch(uri);
        if (response.ok) {
            text1 = await response.text();
            text2 = text1.replace(/\|/g, ", ");
...
// list references if the references option is chosen -----------------------------------------------------------------
    ...
    {
        const uri = "http://gjarman2020.com/cgi-bin/mcaListReferences.cgi";
        let response = await fetch(uri);
        if (response.ok) {
            text1 = await response.text();
            text2 = text1.replace(/\|/g, ", ");
...
// list cohorts if the cohorts option is chosen -----------------------------------------------------------------------
    ...
    {
        const uri = "http://gjarman2020.com/cgi-bin/mcaListCohorts.cgi";
        let response = await fetch(uri);
        if (response.ok) {
            text1 = await response.text();
            text2 = text1.replace(/\|/g, ", ");
...
// list birthdays if the birthdays option is chosen -------------------------------------------------------------------
    ...
    {
        const uri = "http://gjarman2020.com/cgi-bin/mcaListBirthdays.cgi";
        let response = await fetch(uri);
        if (response.ok) {
            text1 = await response.text();
            text2 = text1.replace(/\|/g, ", ");
...
async function fFetchPortraitPeople() {
    const uri = "http://gjarman2020.com/cgi-bin/mcaListPortraitPeople.cgi";
    let response = await fetch(uri);
